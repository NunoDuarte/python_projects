...
assert VersionFormat(uvc.__version__) >= VersionFormat('0.9') #I changed this. it was 0.1. lets hope it works
...
class UVC_Source(Base_Source):
    ...
    def recent_events(self, events):
        try:
            frame = self.uvc_capture.get_frame() #it has 0.05 (no argument needed)
